...
## Project Structure
    ...
    ├── testapiautocatalog_121057  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_121057`
...
2. Clone this repo and `cd testapiautocatalog_121057`
